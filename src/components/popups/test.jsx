...
function convertEmotionToEnglish(label) {
  switch (label) {
    case "hạnh phúc":
      return { label: "hạnh phúc", key: "happy", icon: "😊" };
    case "buồn":
      return { label: "buồn", key: "sad", icon: "😢" };
    case "tức giận":
      return { label: "tức giận", key: "angry", icon: "😡" };
    case "yêu đời":
      return { label: "yêu đời", key: "loving", icon: "😍" };
    case "mệt mỏi":
      return { label: "mệt mỏi", key: "tired", icon: "😴" };
    case "ngạc nhiên":
      return { label: "ngạc nhiên", key: "surprised", icon: "😮" };
    case "cô đơn":
      return { label: "cô đơn", key: "lonely", icon: "🥺" };
    default:
      return null;
  }
}
